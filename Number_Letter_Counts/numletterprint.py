        ...
        for ones_i in range(0, 10):
            if hundreds_i>0:
                if ones_i==0 and tens_i==0:
                    print(ones[hundreds_i]+tens[10])
                    continue
                if tens_i==1:
                    print(ones[hundreds_i]+tens[10]+"and"+teens[ones_i])
                else:
                    print(ones[hundreds_i]+tens[10]+"and"+tens[tens_i]+ones[ones_i])
            else:
                if tens_i==1:
                    print(teens[ones_i])
                else:
                    print(tens[tens_i]+ones[ones_i])
